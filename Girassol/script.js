...
$(document).ready(function() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbwO6D6MJRg7JkyZZ8XGhbcRurLeQkKRAD3O9W91LP4yB7mOF2OIJ-GHo3yx1O6kwMq0_g/exec'; // Substitua pela URL da sua Web App do Apps Script
    ...
    //     const requestData = {
    //         method: "POST",
    //         mode: "no-cors", // Adicionado para evitar bloqueios CORS
    //         headers: {
    //             "Content-Type": "application/json"
    //         },
    //         body: JSON.stringify({ formData, cids })
