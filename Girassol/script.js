  ...
  document.getElementById("myForm").addEventListener("submit", function(event) {
    ...
    // URL do Web App do Google Apps Script (versão /exec)
    const scriptURL = "https://script.google.com/macros/s/AKfycbwuyxPRv4rvYHAun16z0w1ge33I1iZPVp4buZjZdWjovmMcgq2-ltJEI6yYeeKbTCdRbA/exec";
